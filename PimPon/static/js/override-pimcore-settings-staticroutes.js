    ...
    getRowEditor: function () {
        ...
        this.grid = new Ext.grid.EditorGridPanel({
            ...
            tbar: [
                ...
                {
                    text: t('import'),
                    handler: pimcore.plugin.pimpon.handler.importroutes.bind(this),
                    iconCls: "pimpon_icon_importroutes"
                },
                '',
                {
                    text: t('export'),
                    handler: pimcore.plugin.pimpon.handler.exportroutes.bind(this),
                    iconCls: "pimpon_icon_exportroutes"
                },
                "->",
                {
